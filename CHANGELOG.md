...
- **Race picker:** the length choice sits above the cats and the Start button stays pinned; with a big cove only the cat grid scrolls (before, both were pushed off-screen).
- **Café on iPad and larger:** the outside view is pulled back up to 28% so the whole café and garden read, with the sky, sea and grass carried to the edges.
